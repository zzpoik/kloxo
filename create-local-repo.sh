...
mkdir -p /home/rpms/release/kloxo/{i386,i686,x86_64,noarch,SRPMS}
...
mkdir -p /home/rpms/testing/kloxo/{i386,i686,x86_64,noarch,SRPMS}
...
echo "[kloxo-release-local-core]
name=kloxo-release-local-core
baseurl=file:///home/rpms/release/kloxo/noarch/
enabled=1
gpgcheck=0

[kloxo-release-local-noarch]
...
[kloxo-testing-local-core]
name=kloxo-testing-local-core
baseurl=file:///home/rpms/testing/kloxo/noarch/
enabled=0
gpgcheck=0
